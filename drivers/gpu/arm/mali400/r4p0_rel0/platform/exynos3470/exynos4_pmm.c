...
#define MALI_DVFS_STEPS 8
#define MALI_DVFS_STEPS_ISP 8
...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS] = {
	/* step 0 */{160, 1000000,  875000,   0,  62
#ifdef BUSFREQ_QOS_LOCK
		/* mif_min_lock_value */
		, 0
#endif
	},
	/* step 1 */{266, 1000000,  900000,  62,  65
#ifdef BUSFREQ_QOS_LOCK
		/* mif_min_lock_value */
		, 267000
#endif
	},
        /* step 1 */{300, 1000000,  900000,  65,  70
#ifdef BUSFREQ_QOS_LOCK
                /* mif_min_lock_value */
                , 267000
#endif
        },
	/* step 2 */{350, 1000000,  950000,  70,  80
#ifdef BUSFREQ_QOS_LOCK
		/* mif_min_lock_value */
		, 267000
#endif
	},
	/* step 3 */{440, 1000000,  1025000,  80,  85
#ifdef BUSFREQ_QOS_LOCK
		/* mif_min_lock_value */
		, 400000
#endif
	},
	/* step 4 */{533, 1000000,  1075000,  85, 90
#ifdef BUSFREQ_QOS_LOCK
		/* mif_min_lock_value */
		, 400000
#endif
	},
        /* step 1 */{600, 1000000,  1100000,  90,  95
#ifdef BUSFREQ_QOS_LOCK
                /* mif_min_lock_value */
                , 400000
#endif
        },
        /* step 1 */{640, 1000000,  1175000,  95,  100
#ifdef BUSFREQ_QOS_LOCK
                /* mif_min_lock_value */
                , 400000
#endif
...
int mali_min_freq;
int mali_max_freq;
char *mali_freq_table = "640 600 533 440 350 300 266 160";
